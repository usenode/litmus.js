...
Suite = exports.Suite = function (name, tests) {
    this.name = name;
    this.tests = tests;
...
uite.prototype.createRun = function () {
 ...
 * @param {String|Number} ltVal - (required number of string) the value that val must be less than or equ al to.
 * @param {String} message
 *   The message that identifies the assertion.
 *
 * @returns Boolean, true if the assertion passed.
...
Test = exports.Test = function (name, runFunc) {
    this.name = name;
...
StaticFormatter = exports.StaticFormatter = function () {
...
StaticTextFormatter = exports.StaticTextFormatter = function () {
    arguments.callee.base.apply(this, arguments);
};
