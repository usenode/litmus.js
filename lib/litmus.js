...
SuiteRun.prototype.start = function () {
    ...
    promise.all(
        this.suite.tests.map(function (name) {
            // TODO need to work out how to do this with require
            // sync require with node, async with require.js?
            return pkg(name).then(function (test) {
...
var SkippedAssertions = function (reason, assertions) {
