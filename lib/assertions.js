...
exports.builtins.nok = makeAssertion(function (fail, message) {
...
exports.builtins.is = makeAssertion(function (val, isVal, message) {
...
exports.builtins.not = makeAssertion(function (val, notVal, message) {
...
exports.builtins.isa = makeAssertion(function (instance, clss, message) {
...
exports.builtins.gt = makeAssertion(function (val, gtVal, message) {
...
exports.builtins.gte = makeAssertion(function (val, gtVal, message) {
    var passed = val >= gtVal;
    var extra;
    if (! passed) {
...
exports.builtins.lt = makeAssertion(function (val, ltVal, message) {
...
exports.builtins.lte = makeAssertion(function (val, lteVal, message) {
...
exports.builtins.like = makeAssertion(function (val, re, message) {
...
exports.builtins.unlike = makeAssertion(function (val, re, message) {
    var passed = ! re.test(val);
    var extra;
    if (! passed) {
...
exports.builtins.throwsOk = makeAssertion(function (func, re, message) {
