...
exports.runStatic = function (cwd, argv) {
    ...
    for (var i = 0, l = tests.length; i < l; i++) {
        var mod = require(tests[i]);
        if (mod.test && ! (mod instanceof litmus.Test || mod instanceof litmus.Suite)) {
            if (console && console.error) {
                console.error('litmus: exporting test/suite as exports.test is deprecated, use module.exports');
            }
            mod = mod.test;
        }
        var run = mod.createRun();
